...
./alloc 3 s Test_Blocks/block1.i >> test1-3.i
./alloc 3 s Test_Blocks/block2.i >> test2-3.i
./alloc 3 s Test_Blocks/block3.i >> test3-3.i
./alloc 3 s Test_Blocks/block4.i >> test4-3.i
./alloc 3 s Test_Blocks/block5.i >> test5-3.i
./alloc 3 s Test_Blocks/block6.i >> test6-3.i
